...
function App() {
  ...
  return h("div", { className: "blackboard-page" },
      ...
      h("div", { className: "panel" },
        ...
        customMode && h("div", { className: "panel-body custom-panel" },
          ...
          h("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "14px" } },
            h("span", { style: { fontSize: "12px", color: "#94a3b8", fontWeight: 600 } }, "隱藏注音顯示"),
            h(Toggle, { value: hideZhuyin, onChange: function(){setHideZhuyin(function(v){return !v;});} })
          ),
    ...
    h("div", { className: "board-wrap " + (boardPage === "todo" ? "todo-board-mode" : "contact-board-mode") },
      h("div", { ref: bbRef, className: "blackboard-bg" + (hideZhuyin ? " hide-zhuyin" : ""), style: { width: "100%", aspectRatio: "16/9", position: "relative" } },
        h("button", {
          className: "btn-fullscreen",
          style: { right: "95px" },
          onClick: function() { setHideZhuyin(function(v){return !v;}); }
